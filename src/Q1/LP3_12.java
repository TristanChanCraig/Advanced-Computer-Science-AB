...
public class LP3_12 {
    static class ClLP3_12 {
        private double[] expenses;
        private double[] percentBudget;

        public ClLP3_12(double[] expenses) {
        ...
        private void calc() {
            double total = 0;
            for (var expense : expenses) total += expense;
            percentBudget = new double[expenses.length];
            for (int i = 0; i < expenses.length; i++) percentBudget[i] = (expenses[i] / total) * 100;
        }
    ...
    public static void main(String[] args) {
        ...
        var help = new ClLP3_12(expenses);
