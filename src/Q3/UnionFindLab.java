...
public class UnionFindLab { // Island Connectivity Finder
    ...
    public void addBridge(int isle1, int isle2) { unionFind.union(isle1, isle2); }
    public boolean areConnected(int isle1, int isle2) { return unionFind.connected(isle1, isle2); }
    public int numberOfIslandGroups() { return unionFind.count(); }
